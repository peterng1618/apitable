...
export const getEnvVars = () => {
  return {
    ...
    MAX_WIDGET_PANEL_COUNT: process.env.MAX_WIDGET_PANEL_COUNT,
    MAX_AUTOMATION_TRIGGER_COUNT: process.env.MAX_AUTOMATION_TRIGGER_COUNT,
    MAX_AUTOMATION_ACTION_COUNT: process.env.MAX_AUTOMATION_ACTION_COUNT,
  };
};
